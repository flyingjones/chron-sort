...
- Added new parser for [QuickTime Movie Headers](https://developer.apple.com/documentation/quicktime-file-format/movie_header_atom) which allows parsing the meta data of ``mp4`` videos. Works for ``.mp4``, ``.qt`` and ``.mpv`` videos.
